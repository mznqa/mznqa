...
bool SceneLoadResState::update(SceneLoadRes *scene, double intervalTime)
{
	...
	{
	case LogicMessagePQ::LMessage_LoadData_StaticData_CardRoadSet:
	{
	...
	break;
	case LogicMessagePQ::LMessage_LoadData_StaticData_CardSkillSet:
	{
	...
	break;
	case LogicMessagePQ::LMessage_LoadData_StaticData_MapMainMissionSet:
	{
	...
	break;
	case LogicMessagePQ::LMessage_Information_DataLoading_StaticData_CardRoadSetLoadSuccess:
	{
		cocos2d::log("[information] 完成静态数据载入：地形卡集合");
		scene->showProgress("完成静态数据载入：地形卡集合");
	}
	break;
	case LogicMessagePQ::LMessage_Error_DataLoading_StaticData_CardRoadSetLoadFailed:
	{
		cocos2d::log("[error] 载入静态数据出错：地形卡集合");
		scene->showProgress("载入静态数据出错：地形卡集合");
	}
	break;
	case LogicMessagePQ::LMessage_Information_DataLoading_StaticData_CardSkillSetLoadSuccess:
	{
		cocos2d::log("[information] 完成静态数据载入：技能卡集合");
		scene->showProgress("完成静态数据载入：技能卡集合");
	}
	break;
	case LogicMessagePQ::LMessage_Error_DataLoading_StaticData_CardSkillSetLoadFailed:
	{
		cocos2d::log("[error] 载入静态数据出错：技能卡集合");
		scene->showProgress("载入静态数据出错：技能卡集合");
	}
	break;
	case LogicMessagePQ::LMessage_Information_DataLoading_StaticData_MapMainMissionSetLoadSuccess:
	{
		cocos2d::log("[information] 完成静态数据载入：主线任务地图集合");
		scene->showProgress("完成静态数据载入：主线任务地图集合");
	}
	break;
	case LogicMessagePQ::LMessage_Error_DataLoading_StaticData_CardMapMainMissionSetSetLoadFailed:
	{
		cocos2d::log("[error] 载入静态数据出错：主线任务地图集合");
		scene->showProgress("载入静态数据出错：主线任务地图集合");
	}
	break;
	case LogicMessagePQ::LMessage_ReplaceScene_SceneLoadRes2SceneGameMain:
	{
